...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="{{asset('vendor/almasaeed2010/plugins/iCheck/square/blue.css')}}">
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>DPWHBid</b>SYS</a>
    <img src="{{asset('img/dpwh_logo.png')}}" alt="logo" class="img img-responsive" style="width:40%;height:40%;margin-left:auto;margin-right:auto;">
  </div>
  <!-- /.login-logo -->
...
<!-- iCheck -->
<script src="{{asset('vendor/almasaeed2010/plugins/iCheck/icheck.min.js')}}"></script>
<script>
  $(function () {
    $('input').iCheck({
